package ug.co.absa.africa.payments.gateway.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.africa.payments.gateway.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.africa.payments.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.africa.payments.gateway.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "ug.co.absa.africa.payments.gateway"
        );
    }
}
