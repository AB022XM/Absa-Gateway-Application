...
To build the final jar and optimize the AbsaDTGatewayApplication application for production, run:
...
Then navigate to [http://localhost:9800](http://localhost:9800) in your browser.
